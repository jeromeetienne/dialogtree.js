/**
 * @fileOverview Implementation of DialogTree.js - dialog tree in javascript
 * 
 * @license http://jetienne.mit-license.com released under MIT license
 */
...
DialogTree.prototype._isValid	= function(){
	...
	// if all tests passed, return true now
	return true;
};
...
/**
 * notify the answer from the user
 * @param {Number} answerIdx the index of the picked answer 
 */
